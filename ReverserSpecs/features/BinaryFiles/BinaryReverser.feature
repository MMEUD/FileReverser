@changing
Feature: Reverse Binary File
	In order to read the contents of a binary file that contains text that is back-to-front
    As a reader
    I want to create a file that has reversed the content of the binary file
